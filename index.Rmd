...
-   Estudos científicos podem ser classificados em *básicos*, *observacionais*, *experimentais*, *avaliação econômica* e *revisões de literatura*.[@Grant2009; @Süt2014; @Chidambaram2019]

│── Estudos básicos <br>
│ └── Esperimentos com animais <br>
│ └── Desenvolvimento de métodos <br>
│ └── Estudos genéticos <br>
│ └── Estudos celulares <br>
...
│ └──── Transversal <br>
│ └──── Caso-Controle <br>
│ └────── Caso-Controle aninhado <br>
│ └────── Caso-Cohorte <br>
│ └──── Coorte (prospectica ou retrospectiva) <br>

│── Estudos experimentais <br>
│ └── Fases I a IV <br>
│ └──── Aleatorizados controlados <br>
│ └──── Não-aleatorizados controlados <br>
│ └──── Autocontrolados <br>
│ └──── Cruzados <br>
│ └──── Fatorial <br>
│ └── Campo <br>
...
│ └── Análise de custo <br>
│ └── Análise de minimização de custo <br>
│ └── Análise de custo-utilidade <br>
│ └── Análise de custo-efetividade <br>
...
│ └── Mista <br>
│ └── Visão geral <br>
│ └── Sistemática qualitativa <br>
│ └── Rápida <br>
│ └── Escopo <br>
│ └── Estado-da-arte <br>
│ └── Busca e revisão sistemática <br>
│ └── Sistematizada <br>
│ └── Guarda-chuva <br>
