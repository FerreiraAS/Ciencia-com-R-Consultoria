...
<span class="badge rounded-pill bg-primary" style="font-size:0.8em;"> Análise de #276DC2es </span>
...
Opções que desejo incluir [x]: %0D%0A
[  ] Completa: todas as opções abaixo %0D%0A
[  ] Estimativa de tamanho amostral %0D%0A
[  ] Tabela de aleatorização em grupos %0D%0A
[  ] Modelagem de banco de dados %0D%0A
