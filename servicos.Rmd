...
<center>
<a style="font-size:1em;border-width:3px;border-style: solid; border-color:white; border-radius:10px; padding:10px 20px 10px 20px; background-color:red; text-decoration:none; color:white" href="mailto:cienciacomr@gmail.com?subject=
Solicito um orçamento: Mentoria agendada
&body=
Tema da sua pesquisa: %0D%0A %0D%0A %0D%0A
Prazo para conclusão da consultoria: %0D%0A %0D%0A %0D%0A
Marque com [ x ] as opções que deseja incluir: %0D%0A
[  ] Mentoria agendada %0D%0A %0D%0A
Opcional: Inclua arquivos em anexo %0D%0A
...
<center>
<a style="font-size:1em;border-width:3px;border-style: solid; border-color:white; border-radius:10px; padding:10px 20px 10px 20px; background-color:red; text-decoration:none; color:white" href="mailto:cienciacomr@gmail.com?subject=
Solicito um orçamento: Elaboração de projetos
&body=
Tema da sua pesquisa: %0D%0A %0D%0A %0D%0A
Prazo para conclusão da consultoria: %0D%0A %0D%0A %0D%0A
Marque com [ x ] as opções que deseja incluir: %0D%0A
[  ] Revisão de métodos %0D%0A
[  ] Revisão de estilo científico %0D%0A
[  ] Revisão de aspectos éticos %0D%0A
...
<center>
<a style="font-size:1em;border-width:3px;border-style: solid; border-color:white; border-radius:10px; padding:10px 20px 10px 20px; background-color:red; text-decoration:none; color:white" href="mailto:cienciacomr@gmail.com?subject=Solicito um orçamento: Computação estatística&body=Tema da sua pesquisa: %0D%0A %0D%0A %0D%0A Fale sobre o seu projeto: %0D%0A %0D%0A %0D%0A Prazo para conclusão da consultoria: %0D%0A %0D%0A %0D%0A Inclua arquivos em anexo %0D%0A %0D%0A %0D%0A"><b>`r library(fontawesome); fa("envelope", margin_right = "0.3em")` Orçamento</b></a>
</center>
...
<center>
<a style="font-size:1em;border-width:3px;border-style: solid; border-color:white; border-radius:10px; padding:10px 20px 10px 20px; background-color:red; text-decoration:none; color:white" href="mailto:cienciacomr@gmail.com?subject=Solicito um orçamento: Computação biomédica&body=Tema da sua pesquisa: %0D%0A %0D%0A %0D%0A Fale sobre o seu projeto: %0D%0A %0D%0A %0D%0A Prazo para conclusão da consultoria: %0D%0A %0D%0A %0D%0A Inclua arquivos em anexo %0D%0A %0D%0A %0D%0A"><b>`r library(fontawesome); fa("envelope", margin_right = "0.3em")` Orçamento</b></a>
</center>
...
<center>
<a style="font-size:1em;border-width:3px;border-style: solid; border-color:white; border-radius:10px; padding:10px 20px 10px 20px; background-color:red; text-decoration:none; color:white" href="mailto:cienciacomr@gmail.com?subject=Solicito um orçamento: Submissão de manuscritos&body=Tema da sua pesquisa: %0D%0A %0D%0A %0D%0A Fale sobre o seu projeto: %0D%0A %0D%0A %0D%0A Prazo para conclusão da consultoria: %0D%0A %0D%0A %0D%0A Inclua arquivos em anexo %0D%0A %0D%0A %0D%0A"><b>`r library(fontawesome); fa("envelope", margin_right = "0.3em")` Orçamento</b></a>
</center>
