...
colnames(peer.review) <- c(paste("Periódicos (", length(journals), ")", sep = ""), "SJR")
  
# exibe a tabela
kable(peer.review, align = "l", format = "html", escape = FALSE) %>%
...
my_dois_works <-
  my_dois_works[order(as.vector(my_dois_works$title_title_value)), ]
