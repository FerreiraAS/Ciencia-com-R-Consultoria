...
for (i in 1:dim(doi_sort)[1]) {
  ...
  cat(
    ...
    SJR_id,
    "&tip=sid&clean=0\" style=\"border-radius:10%; margin:0.1em 0.3em 0.1em 0.3em; padding:0.5em 0.3em 0.5em 0.3em; font-size: 0.8em; text-decoration:none; text-align: center; display:inline-block; float:left; color:white; background-color:rgb(216,124,78);\"> SJR <br>",
    sep = ""
  )
  SJR <-
  ...
  # add QUALIS
  cat(
    "<a style=\"border-radius:10%; border-style: solid; margin:0.1em 0.3em 0.1em 0.3em; padding:0.4em 0.3em 0.4em 0.3em; font-size: 0.8em; text-decoration:none; text-align: center; display:inline-block; float:left; color:black;\"> Qualis <br>",
    sep = ""
  )
