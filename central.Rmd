...
-   Testes t e regressões logísticas podem ser aplicados para identificaar relações entre variáveis com e sem dados perdidos, criando um fator de análise ('dado perdido' = 1, 'dado observado' = 0).[@Heymans2022]
