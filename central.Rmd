...
::: blue
`r library(fontawesome); fa("r-project", margin_right = "0.1em")` O pacote *ggplot2*[@ggplot2] fornece funções para construção de gráficos [`r library(fontawesome); fa("up-right-from-square", margin_right = "0.1em")`](https://cran.r-project.org/web/packages/ggplot2/index.html)
:::
