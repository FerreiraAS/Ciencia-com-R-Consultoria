...
::: blue
`r library(fontawesome); fa("r-project", margin_right = "0.1em")` O pacote *misty*[@misty] fornece a função *na.test* para executar o Little's Missing Completely at Random (MCAR) test. [`r library(fontawesome); fa("up-right-from-square", margin_right = "0.1em")`](https://cran.r-project.org/web/packages/misty/index.html)
:::
